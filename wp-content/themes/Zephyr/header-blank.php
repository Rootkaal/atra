...
?>
<html class="<?php echo esc_attr($no_responsive_class);?>" <?php language_attributes('html')?>>
<head>
	<meta charset="UTF-8">
...
?>
<body <?php body_class('l-body'); ?><?php echo  ($body_background_styles_text != '')?' style="'.$body_background_styles_text.'"':''; ?> ontouchstart="">
<!-- CANVAS -->
<div class="l-canvas">
