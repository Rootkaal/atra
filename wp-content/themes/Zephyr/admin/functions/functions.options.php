...
$of_options[] = array( "name" => "Logo Image in the Transparent Header <span class='w-info'>(optional)</span>",
	"desc" => "Maximum recommended size is 300px of height (also for retina displays)",
...
$of_options[] = array( "name" => "Logo Height in the Sticky Header",
	"desc" => "Set value from 20 to 150 (px)",
...
$of_options[] = array( "name" => "Title Bar Color Style",
	"desc" => "Set default color style of Title Bar on all pages",
...
$of_options[] = array(
	"name" =>  "Boxed Layout",
	"desc" => "Activate Boxed layout of site pages",
	"id" => "boxed_layout",
	"std" => 0,
	"folds" => 1,
	"type" => "switch"
...
$of_options[] = array( "name" => "Site Canvas Width",
	"desc" => "Set value from 1000 to 1400 (px)",
...
$of_options[] = array( "name" => "Site Content Width",
	"desc" => "Set value from 900 to 1300 (px)",
...
$of_options[] = array( "name" => "Sidebar Width <span class='w-info'>(for pages with sidebar only)</span>",
	"desc" => "Set value from 20 to 50 (%)",
	"id" => "sidebar_width",
	"type" => "sliderui",
	"std" => "25",
	"min" => "20",
...
$of_options[] = array( "name" => "Content Width <span class='w-info'>(for pages with sidebar only)</span>",
	"desc" => "Set value from 50 to 80 (%)",
	"id" => "content_width",
	"type" => "sliderui",
	"std" => "68",
	"min" => "50",
...
$of_options[] = array( "name" => "Columns Stacking Width",
	"desc" => "When screen width is less than this value, all columns in one row will be stacked in a single column",
...
$of_options[] = array( "name" => "Disabling Animation Width",
	"desc" => "When screen width is less than this value, animation of elements appearance will be disabled",
...
$of_options[] = array( "name" => "Predefined Color Style",
	...
	"options" => array(
		...
		'Teal Serenity' => 'Teal Serenity',
		'Sunny Cocktail' => 'Sunny Cocktail',
		'Light Tangerine' => 'Light Tangerine',
		'Green Darkness' => 'Green Darkness',
		'Wet Stone' => 'Wet Stone',
	));
...
$of_options[] = array( "name" =>  "",
	"desc" => "Transparent Header Text Color",
...
$of_options[] = array( "name" =>  "",
	"desc" => "Transparent Menu Hover Text Color",
	"id" => "transparent_header_text_hover",
	"std" => "#fff",
...
$of_options[] = array( "name" =>  "",
	"desc" => "Transparent Menu Active Text Color",
	"id" => "transparent_menu_active_text",
	"std" => "#ffc670",
	"fold" => "change_main_menu_colors",
	"type" => "color");
...
$of_options[] = array( "name" => "Disable Sticky Header at width:",
	"desc" => "When screen width is less than this value, sticky header transforms to non-sticky",
...
$of_options[] = array( "name" => "Height of the extra Header area",
	"desc" => "Set value from 40 to 60 (px)",
...
$of_options[] = array( "name" => "Custom Item Icon",
	"desc" => "Paste <a href='http://fontawesome.io/icons/' target='_blank'>FontAwesome</a> or <a href='http://designjockey.github.io/material-design-fonticons/' target='_blank'>Material Design</a> icon name in&nbsp;this field",
	"id" => "header_custom_icon",
	"std" => "",
	"fold" => "header_show_contacts",
	"type" => "text");

$of_options[] = array( "name" => "Custom Item Text",
	"desc" => "Use can use HTML tags in this field (e.g. &lt;a href=\"\"&gt;&lt;/a&gt; for adding links)",
...
$of_options[] = array( "name" => "Transform Menu to Mobile View at Width:",
	"desc" => "When screen width is less than this value, main menu transforms to mobile-friendly layout",
	"id" => "mobile_nav_width",
	"std" => "1000",
	"type" => "text");
...
if ( class_exists( 'woocommerce' ) ) {
	...
	$of_options[] = array( "name" => "Products Listing Style",
		"desc" => "",
		"id" => "products_listing_style",
		"std" => 2,
		"type" => "select",
		"options" => array(
			'Flat style',
...
$of_options[] = array( 	"name" 		=> "TF_Update",
	"std" 		=> "Please enter your Themeforest username and Secret API Key below if you want to get update notifications for ZEPHYR theme.",
	"id" 		=> "themeforest_info",
	"type" 		=> "info"
);
