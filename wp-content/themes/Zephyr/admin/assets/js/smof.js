...
jQuery(document).ready(function($) {
	var colors = {
		color_0: {
			...
			transparent_header_text: '#fff',
			transparent_header_text_hover: '#fff',
			search_bg: '#7049ba',
			search_text: '#fff',
			...
			transparent_menu_active_text: '#ffc670',
			drop_bg: '#fff',
			drop_text: '#212121',
			drop_hover_bg: '#eee',
		...
		color_1: {
			...
			transparent_menu_active_text: '#7dfadb',
			drop_bg: '#00897b',
			drop_text: '#fff',
		...
		color_2: {
			...
			menu_active_text: '#212121',
			transparent_menu_active_text: '#ffb300',
			drop_bg: '#fff',
			drop_text: '#212121',
		...
		color_3: {
			...
			transparent_menu_active_text: '#ff5722',
			drop_bg: '#25282b',
			drop_text: '#c2c4c5',
		...
		color_4: {
			...
			transparent_menu_active_text: '#3fd13d',
			drop_bg: '#1d1d1d',
			drop_text: '#aaa',
		...
		color_5: {
			...
			transparent_menu_active_text: '#80cbc4',
			drop_bg: '#1b2327',
			drop_text: '#b0bec5',
			...
			subfooter_link_hover: '#69aaf0',
			footer_bg: '#12171a',
			footer_text: '#82939c',
			footer_link: '#b0bec5',
			footer_link_hover: '#69aaf0'
		}
	}
	...
	jQuery('#section-main_header_layout .of-radio-img-img').on('click', function(){
		...
		if (layout == 'standard' || layout == 'centered') {
			...
			jQuery('#section-header_social_deviantart').slideUp('normal', "swing");
			jQuery('#section-header_social_foursquare').slideUp('normal', "swing");
			jQuery('#section-header_social_github').slideUp('normal', "swing");
