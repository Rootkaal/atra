...
class US_Widget_Login extends WP_Widget {
	...
	function __construct()
	{
		...
		$control_ops = array();
		$this->WP_Widget('login', 'Zephyr: Login', $widget_ops, $control_ops);
	}
				...
				<form method="post" action="<?php echo site_url( 'wp-login.php' ); ?>" autocomplete="off">
					...
					<div class="w-form-row">
						<div class="w-form-field">
							...
							<span class="w-form-field-label"><?php echo __( 'Username', 'us' ) ?></span>
					...
					<div class="w-form-row">
						<div class="w-form-field">
							...
							<span class="w-form-field-label"><?php echo __( 'Password', 'us' ) ?></span>
							<span class="w-form-field-bar"></span>
						</div>
						<div class="w-form-state"></div>
					</div>
					<div class="w-form-row for_submit">
						<div class="w-form-field">
							<button class="g-btn type_raised color_primary"><span><?php echo __( 'Log In', 'us' ) ?></span></button>
