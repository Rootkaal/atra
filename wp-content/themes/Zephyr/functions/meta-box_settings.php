...
$header_titlebar_fields = array (
	...
	array(
		...
		'options'	=> array(
			'' => 'Default (set at Theme Options)',
			'default' => 'Content bg | Content text',
			'alternate' => 'Alternate bg | Content text',
...
$meta_boxes[] = array(
	'id' => 'zephyr_post_page_portfolio_header_settings',
...
$meta_boxes[] = array(
	'id' => 'zephyr_page_portfolio_titlebar_settings',
...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
			'name'		=> 'Open Portfolio Image in a lightbox',
			'id'		=> $prefix . "lightbox",
			'type'		=> 'checkbox',
			'std'		=> false,
		),
...
$meta_boxes[] = array(
	'id' => 'zephyr_common_footer_settings',
