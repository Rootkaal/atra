...
vc_add_params('vc_row', array(
	array(
		"type" => 'checkbox',
		"heading" => __("Boxed Columns", "js_composer"),
		"param_name" => "boxed_columns",
		"description" => "",
		"value" => Array(__("Enable boxed columns", "js_composer") => 'yes'),
	),
	array(
		"type" => "checkbox",
	...
	array(
		...
		"value" => array(__('Content bg color | Content text color', "js_composer") => "", __('Alternate bg color | Content text color', "js_composer") => "alternate", __('Primary bg color | White text color', "js_composer") => "primary", __('Secondary bg color | White text color', "js_composer") => "secondary", __('Custom colors', "js_composer") => "custom",),
...
vc_add_params('vc_column', array(
	...
	array(
		"type" => "attach_image",
		"heading" => __("Column Background Image", "js_composer"),
		"param_name" => "img",
		"value" => "",
		"description" => __("Leave empty if you don't want to use the background image", "js_composer"),
	),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"description" => "",
			"value" => Array(__("Enable lightbox with the original image on click", "js_composer") => 'yes')
		),
		array(
			"type" => "textfield",
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"param_name" => "icon",
			"value" => "",
			"description" => sprintf('<a href="http://fontawesome.io/icons/" target="_blank">FontAwesome</a> or <a href="http://designjockey.github.io/material-design-fonticons/" target="_blank">Material Design</a> icons'),
			"edit_field_class" => "vc_col-sm-6 vc_column",
		),
		array(
			"type" => "textfield",
			...
			"param_name" => "text",
			"value" => "",
			"description" => __("Displays text in the middle of this separator", "js_composer" ),
			"edit_field_class" => "vc_col-sm-6 vc_column",
		),
		array(
			'type' => 'textfield',
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "color",
			"value" => array(__("Primary (theme color)", "js_composer") => "primary",
				__("Secondary (theme color)", "js_composer") => "secondary",
				__("Light (theme color)", "js_composer") => "light",
				__("Contrast (theme color)", "js_composer") => "contrast",
		...
		array(
			...
			"param_name" => "type",
			"value" => array(__("Raised", "js_composer") => "raised",
		...
		array(
			...
			"param_name" => "iconpos",
			"value" => array(__("Left", "js_composer") => "", __("Right", "js_composer") => "right",),
			"description" => '',
		...
		array(
			...
			"param_name" => "size",
			"value" => array(__("Medium", "js_composer") => "", __("Large", "js_composer") => "big"),
			"description" => '',
			"edit_field_class" => "vc_col-sm-6 vc_column",
		),
		array(
		...
		array(
			...
			"heading" => '',
			"param_name" => "external",
			"value" => array(__( 'Open button link in a new tab', 'js_composer' ) => true ),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "active",
			"value" => Array(__("Open this tab when page load", "js_composer") => 'yes')
		),
		array(
			"type" => 'checkbox',
...
vc_map( array(
	...
	"params" => array(
		array(
			...
			"param_name" => "title",
			"description" => __("Enter the section title here (better keep it short)", "js_composer")
		),
		array(
			"type" => "textfield",
			"heading" => __("Section Icon (optional)", "js_composer"),
			"param_name" => "icon",
			"description" => sprintf('<a href="http://fontawesome.io/icons/" target="_blank">FontAwesome</a> or <a href="http://designjockey.github.io/material-design-fonticons/" target="_blank">Material Design</a> icons')
		),
		array(
			...
			"heading" => __("Active", "js_composer"),
			"param_name" => "active",
			"value" => Array(__("Open this section when page load", "js_composer") => 'yes')
		),
		array(
			"type" => 'checkbox',
			"heading" => __("Full Size Content", "js_composer"),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "type",
			"value" => array(__('Simple', "js_composer") => "default", __('Inside the circle', "js_composer") => "circle", ),
			"description" => '',
			"edit_field_class" => "vc_col-sm-6 vc_column",
		),
		array(
		...
		array(
			"type" => "textarea",
			"heading" => __("Iconbox content (optional)", "js_composer"),
			"param_name" => "content",
			"value" => '',
			"description" => ''
		),
...
vc_map( array(
	...
	"params" => array(
		array(
			"type" => "dropdown",
			"heading" => __("Quote Style", "js_composer"),
			"param_name" => "type",
			"value" => array('Card Style' => '1', 'Flat Style' => '2',),
			"description" => '',
		),
		array(
			"type" => "textarea",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "link",
			"value" => "",
			"description" => __("Applies to the Name and to the Photo", "js_composer"),
		),
		array(
			'type' => 'checkbox',
			'heading' => '',
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "style",
			"value" => array('Type 1' => 'type_1', 'Type 2' => 'type_2', 'Type 3' => 'type_3', 'Type 4' => 'type_4', 'Type 5' => 'type_5', ),
			"description" => '',
			"edit_field_class" => "vc_col-sm-6 vc_column",
		),
		array(
...
vc_map( array(
	...
	"params" => array(
		array(
			...
			"param_name" => "type",
			"value" => array('Large Image' => 'large_image', 'Small Image' => 'small_circle_image', 'Masonry Grid' => 'masonry', ),
			"description" => ''
		),
		array(
			"type" => "textfield",
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "type",
			"value" => array('Card Style' => 'raised', 'Flat Style' => 'flat',),
			"description" => ''
		),
		array(
			"type" => 'checkbox',
...
vc_map( array(
	...
	"params" => array(
		array(
			"type" => "dropdown",
			"heading" => __("ActionBox Color Style", "js_composer"),
			"param_name" => "type",
			"value" => array(
				__('Primary bg | White text', "js_composer") => "primary",
				__('Secondary bg | White text', "js_composer") => "secondary",
				__('Alternate bg | Content text', "js_composer") => "alternate",
				__('Custom colors', "js_composer") => "custom",
			),
			"description" => '',
		),
		array(
		...
		array(
			"type" => "dropdown",
			"heading" => __("Button Icon Position", "js_composer"),
			"param_name" => "button_iconpos",
			"value" => array(__("Left", "js_composer") => "", __("Right", "js_composer") => "right",),
			"description" => '',
			"dependency" => Array('element' => "button_icon", 'not_empty' => true),
		),
		array(
			"type" => "checkbox",
			"heading" => '',
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "color",
			"value" => array(__("Heading (theme color)", "js_composer") => "", __("Primary (theme color)", "js_composer") => "primary", __("Secondary (theme color)", "js_composer") => "secondary", __("Custom Color", "js_composer") => "custom",),
			"description" => '',
			"edit_field_class" => "vc_col-sm-6 vc_column",
		),
		array(
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"heading" => '',
			"param_name" => "inverted",
			"value" => array(__("Invert colors for all icons", "js_composer") => "yes"),
		),
		array(
			"type" => "checkbox",
			"heading" => '',
			"param_name" => "desaturated",
			"value" => array(__("Desaturate all icons", "js_composer") => "yes"),
		),
		array(
			"type" => "textfield",
			"heading" => __("Email", "js_composer"),
...
if (is_admin()){
	...
	if (is_plugin_active('zephyr_js_composer/zephyr_js_composer.php')){
		deactivate_plugins('zephyr_js_composer/zephyr_js_composer.php');
	}
}