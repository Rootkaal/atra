...
$image_string = !empty($link_to) ? '<a'.$a_class.' href="'.esc_url($link_to).'"'.$target_arg.$ref.'>'.$img.'</a>' : $img;
...
$css_class =  'wpb_single_image wpb_content_element'.$el_class.$custom_css_class;
