...
$output = '<div id="gallery_'.$rand_id.'" class="w-gallery'.$el_class.$type_classes.$masonry_class.$indents_class.' animate_revealgrid"> <div class="w-gallery-tnails">';
...
if (is_array($attachments))
{
	foreach ($attachments as $id => $attachment) {
		...
		$output .= '<a class="w-gallery-tnail order_'.$i.' animate_reveal" href="'.wp_get_attachment_url($id).'" title="'.$title.'">';
