	...
	<div class="w-lang layout_dropdown">
		<div class="w-lang-h">
			<div class="w-lang-list">
				...
				?>
				<a class="w-lang-item lang_<?php echo esc_attr($language['language_code']); ?>" href="<?php echo esc_url($language['url']); ?>">
		...
		<div class="w-lang-h">
			<div class="w-lang-list">
				<?php for ($i = 2; $i <= $smof_data['header_language_amount']; $i++) {
					?>
					<a class="w-lang-item" href="<?php echo (substr($smof_data['header_language_'.$i.'_url'], 0, 4) == 'http')?esc_url($smof_data['header_language_'.$i.'_url']):esc_url('//'.$smof_data['header_language_'.$i.'_url']); ?>">
						<span class="w-lang-item-icon"></span>
